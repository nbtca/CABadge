...
#define UI_VERSION "7.3.7-mem"
typedef struct {
    int brightness;
    bool reduced_motion;
    int wallpaper_index; /* 0 default, 1 ribbons, 2 uploaded; persisted selection */
    int battery_mv;
...
typedef struct { char ssid[33]; int rssi; unsigned security; } badge_wifi_ap_t; /* 0=open,1=personal,2=enterprise */
typedef struct {
    void (*scan)(void);
...
enum { BADGE_APPLY=1, BADGE_BRIGHTNESS, BADGE_REDUCED, BADGE_SLEEP };
